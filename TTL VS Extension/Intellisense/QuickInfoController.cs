...
namespace TTL.Intellisense {
    ...
    internal class TemplateQuickInfoController: IIntellisenseController {
        ...
        internal TemplateQuickInfoController
            (ITextView textView, IList<ITextBuffer> subjectBuffers, TemplateQuickInfoControllerProvider componentContext)
        {
            _textView = textView;
        ...
        private SnapshotPoint? GetMousePosition (SnapshotPoint topPosition)
        {
            ...
            return _textView.BufferGraph.MapDownToFirstMatch
                (topPosition, PointTrackingMode.Positive, snapshot => _subjectBuffers.Contains(snapshot.TextBuffer), PositionAffinity.Predecessor);
        }

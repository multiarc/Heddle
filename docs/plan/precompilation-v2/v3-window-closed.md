# The v3 breaking window (closed)

> Closed with the 3.0.0 release: every item is implemented, reconciled against shipped source, and
> condensed into the [release records](../../spec/common/cross-cutting-decisions.md#release-records--as-shipped)
> and the [*Program record — precompilation v2*](../../spec/common/cross-cutting-decisions.md#program-record--precompilation-v2-closed).
> This document is frozen as the window's planning record.

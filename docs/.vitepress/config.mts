...
export default withMermaid(
  defineConfig({
    ...
    srcExclude: [
      ...
      'benchmarks/*/dotnet/**',
      // Generated by benchmarks/report/consolidate.py and pulled into each report's index.md
      // with `<!--@include:-->`. It is a fragment, not a page: excluding it keeps the include
      // working (the directive reads from disk at build time) while avoiding a duplicate route
      // whose headings would compete with the report's own in local search.
      'benchmarks/*/summary-tables.md'
    ],

...
export default withMermaid(
  defineConfig({
    ...
    srcExclude: [
      ...
      'benchmarks/*/dotnet/**'
      // summary-tables.md is generated by benchmarks/report/consolidate.py and embedded into the
      // report's index.md with `<!--@include:-->`, but it is NOT excluded here: the Benchmarks
      // sidebar links it as its own page, and an excluded source would turn that entry into a 404.
    ],

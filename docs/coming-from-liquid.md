...
> compile time (see [that section](#include-and-render-versus-partial)).
...
## Double braces are a body, not interpolation
...
## Filters become chains, composed right-to-left
...
[chain](language-reference.md#chaining-with-the-colon) composes **right-to-left**: the rightmost call renders
...
## Include and render versus partial

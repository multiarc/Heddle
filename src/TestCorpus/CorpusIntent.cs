    ...
    internal static class CorpusIntent
    {
        ...
        public static readonly IReadOnlyList<CorpusIntentRow> Rows = new[]
        {
            ...
            new CorpusIntentRow("ctx-encoding.heddle", CorpusTier.FallsBackSafely, CorpusRender.Standalone,
                "Context-encoding golden fixture; the encoder shapes it exercises are not emitter-supported, and it renders model-less on the dynamic tier."),
            new CorpusIntentRow("dynamic-recursion.heddle", CorpusTier.FallsBackSafely, CorpusRender.WithModel,
                "Recursion through the dynamic tier with FullCSharp expressions the emitter cannot type; HeddleTemplateTests owns its bytes.",
                bom: true),
            ...
            new CorpusIntentRow("recursion.heddle", CorpusTier.FallsBackSafely, CorpusRender.WithModel,
                "Recursion with FullCSharp expressions the emitter cannot type; HeddleTemplateTests owns its bytes.",
                bom: true),
            ...
            new CorpusIntentRow("template.heddle", CorpusTier.FallsBackSafely, CorpusRender.WithModel,
                "The original flagship document: FullCSharp expressions throughout, which the emitter refuses; HeddleTemplateTests owns its bytes.",
                bom: true),
            new CorpusIntentRow("tuple_array.heddle", CorpusTier.FallsBackSafely, CorpusRender.WithModel,
                "Tuple/array FullCSharp expressions the emitter cannot type; HeddleTemplateTests owns its bytes."),

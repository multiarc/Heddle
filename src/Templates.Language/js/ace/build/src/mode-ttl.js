...
define("ace/mode/folding/ttl",["require","exports","module","ace/lib/oop","ace/range","ace/mode/folding/fold_mode","ace/token_iterator"], function (require, exports, module) {
    "use strict";
        ...
        this._readBlockBackward = function(iterator, endBlock) {
            ...
            do {
                ...
                if (tokenTable[token.value]) {
                    ...
                    iterator.stepBackward();
                    return tag;
                } else if (reverseTokenTable[token.value]) {
                    tag.end.row = iterator.getCurrentTokenRow();
                    tag.end.column = iterator.getCurrentTokenColumn() + token.value.length;
                }
            } while(token = iterator.stepBackward());
        ...
        this.getFoldWidgetRange = function(session, foldStyle, row) {
            ...
            if (!isBackward) {
                ...
                while (block = this._readBlockForward(iterator, startBlock.token)) {
                    ...
                    if (block.start.row === startBlock.start.row && block.start.column === startBlock.start.column)
                        continue;
                ...
                while (block = this._readBlockBackward(iterator)) {
                    if (!block.closing) {
                        this._pop(stack, block);
                        if (stack.length === 0) {
                            block.start.column += block.token.length + 1;
...
define("ace/mode/ttl_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/html_highlight_rules","ace/mode/csharp_highlight_rules"], function (require, exports, module) {
    "use strict";
    ...
    var TtlHighlightRules = function (options) {
        ...
        function createPushRule(regex, token, current, next) {
            return {
                regex: regex,
                onMatch: getPushMode(token, current, next)
            }
        }
        ...
        function getPushMode(token, current, next) {
        ...
        var ttlRules = {
            "start": [
                ...
                {
                    token: "start.keyword.paren.lparen",
                    regex: /@{/,
                    next: "ttl-raw"
                },
                {
                ...
                {
                    token: "start.keyword.operator.paren.lparen",
                    regex: /@%/,
                    next: "ttl-def"
                },
                {
                    token: "start.keyword.operator",
                    regex: /@<</,
                    next: "ttl-import"
                },
                {
                    token: "start.support.function",
                    regex: /@/,
                    next: "ttl-out"
                },
            ],
            "ttl-out": [
                ...
                },
                {
                    ...
                    onMatch: function (val, state, stack) {
                        stack.shift();
                        stack.unshift("ttl-call-returned");
                        stack.unshift("ttl-call");
                        this.next = "ttl-call";
                        return "ttl-out.keyword.paren.lparen";
                    },
                },
                {
                    token: "ttl-out.punctuation.operator",
                    regex: /:/,
                    next: "ttl-out",
                },
                {
            ...
            "ttl-call-returned": [
                ...
                {
                    token: "ttl-call-returned.punctuation.operator",
                    regex: /:/,
                    next: "ttl-out",
                },
                {
                    token: "ttl-call-returned.keyword.operator",
                    regex: /@/,
                    next: "ttl-out",
                },
                {
                ...
                {
                    token: "ttl-call-returned.comment.block",
                    regex: /@\\\\\s*/,
                    next: "ttl-call-returned"
                },
                {
                    token: "ttl-call-returned.text",
                    regex: /\s+/,
                    next: "ttl-call-returned"
                },
                createPopRule("", "constant.other")
            ],
            "ttl-call": [
                createPushRule(
                    /@\*/,
                    "ttl-call.comment.block",
                    "ttl-call",
                    "ttl-comment"
                ),
                {
                ...
                {
                    token: "ttl-call.punctuation.operator",
                    regex: /:/,
                    next: "ttl-call",
                },
                {
                ...
                {
                    token: "ttl-call.variable.language",
                    regex: /[a-zA-Zа-яА-Я_]+[a-zA-Zа-яА-Я0-9_]*/,
                    next: "ttl-call"
                },
                {
            ...
            "ttl-import": [
                createPushRule(
                    /@\*/,
                    "ttl-import.comment.block",
                    "ttl-import",
                    "ttl-comment"
                ),
                {
                    token: "ttl-import.keyword.operator.paren.lparen",
                    regex: /{{/,
                    next: "ttl-import"
                },
                {
                    token: "ttl-import.constant.other",
                    regex: /[^{}]+/,
                    next: "ttl-import"
                },
                createPopRule(
            ...
            "ttl-def": [
                createPushRule(
                    /@\*/,
                    "ttl-def.comment.block",
                    "ttl-def",
                    "ttl-comment"
                ),
                {
                    token: "ttl-def.punctuation.operator.paren.lparen",
                    regex: /</,
                    next: "ttl-def-name"
                },
                createPushRule(
                ...
                {
                    token: "ttl-def.keyword.operator",
                    regex: /::/,
                    next: "ttl-def"
                },
                {
                    token: "ttl-def.whitespace",
                    regex: /\s+/,
                    next: "ttl-def"
                },
                createPopRule(
            ...
            "ttl-def-name": [
                {
                    token: "ttl-def-name.identifier",
                    regex: /[a-zA-Zа-яА-Я_]+[a-zA-Zа-яА-Я_0-9.]*/,
                    next: "ttl-def-name"
                },
                {
                    token: "ttl-def-name.keyword.operator",
                    regex: /:/,
                    next: "ttl-def-name"
                },
                {
                    token: "ttl-def-name.punctuation.operator.paren.rparen",
                    regex: />/,
                    next: "ttl-def"
                },
            ],
            "ttl-generic-type": [
                {
                    token: "ttl-generic-type.storage.type",
                    regex: /[a-zA-Zа-яА-Я_]+[a-zA-Zа-яА-Я_0-9.,]*(\[])*/,
                    next: "ttl-generic-type"
                },
                {
                    token: "ttl-generic-type.storage.type",
                    regex: /(\[])+/,
            ...
            "ttl-sub": [
                ...
                {
                    token: "ttl-sub.support.function",
                    regex: /@/,
                    next: "ttl-out"
                },
                createPopRule(
            ...
            "ttl-comment": [
                ...
                {
                    token: "ttl-comment.comment.block",
                    regex: /([^*]|\*[^@])+/,
                    next: "ttl-comment"
                }
            ]
...
define("ace/mode/ttl_brace_outdent",["require","exports","module","ace/range"], function (require, exports, module) {
    "use strict";
...
define("ace/mode/behaviour/ttl",["require","exports","module","ace/lib/oop","ace/mode/behaviour","ace/token_iterator","ace/lib/lang"], function(require, exports, module) {
"use strict";
...
define("ace/mode/ttl_completions",["require","exports","module","ace/token_iterator"], function(require, exports, module) {
"use strict";
...
define("ace/mode/ttl",["require","exports","module","ace/lib/oop","ace/mode/html","ace/mode/folding/ttl","ace/mode/ttl_highlight_rules","ace/mode/ttl_brace_outdent","ace/mode/behaviour/ttl","ace/mode/ttl_completions","ace/worker/worker_client"], function(require, exports, module) {
    "use strict";
    ...
    exports.Mode = Mode;
                    ...
                    window.require(["ace/mode/ttl"], function(m) {

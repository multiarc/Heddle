...
namespace Heddle.Build.Tests
{
    ...
    /// as <c>src/Heddle.Build.Tests/test-classes.txt</c>, compared as a set. It is what CI has instead of a
    ...
    public class TestClassInventoryTests
    {
        ...
        public void ThisSuiteDeclaresExactlyTheTestClassesCheckedIn()
        {
            TestClassInventory.AssertMatchesCheckedInInventory(
                typeof(TestClassInventoryTests).Assembly, "src/Heddle.Build.Tests/test-classes.txt");
        }
    }
}

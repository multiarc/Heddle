...
namespace Heddle.Precompiled
{
    ...
    public static class PrecompiledFunctions
    {
        ...
        public static ForModel Range(int start, int last) => BuiltInFunctions.Range(start, last);
        public static ForModel Range(int start, int last, int step) => BuiltInFunctions.Range(start, last, step);
    }
}

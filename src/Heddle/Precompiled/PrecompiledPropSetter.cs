...
{
    /// <summary>Dynamic prop-argument evaluator: invoked against the caller view
    ...
    /// <summary>One dynamic prop assignment for a precompiled definition call site: the prop's layout

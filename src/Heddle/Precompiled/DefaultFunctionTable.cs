...
namespace Heddle.Precompiled
{
    ...
    internal static class DefaultFunctionTable
    {
        ...
        private const string ForModel = "Heddle.Models.ForModel";
        ...
        public static readonly IReadOnlyList<DefaultFunctionRow> Rows = new[]
        {
            ...
            new DefaultFunctionRow("range", "Range", new[] { Int, Int }, ForModel),
            new DefaultFunctionRow("range", "Range", new[] { Int, Int, Int }, ForModel),
        };
    }
}

...
{
    /// <summary>
    /// The fill materialization — the single, parse-model-pure source of the layered
    ...
    /// (which clobbers <c>ModelType</c> and drops the region flags).
    /// </summary>
    internal static class DefinitionMaterializer
    {
        ...
        /// (<c>WalkValidateDefinitionType</c>) and HED5019 land at the override.
        /// </summary>

...
namespace Heddle.Generator.Tests
{
    ...
    /// as <c>src/Heddle.Generator.Tests/test-classes.txt</c>, compared as a set. It is what CI has instead of a
    ...
    public class TestClassInventoryTests
    {
        ...
        public void ThisSuiteDeclaresExactlyTheTestClassesCheckedIn()
        {
            TestClassInventory.AssertMatchesCheckedInInventory(
                typeof(TestClassInventoryTests).Assembly, "src/Heddle.Generator.Tests/test-classes.txt");
        }
    }
}

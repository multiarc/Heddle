...
namespace Heddle.Generator.Emit
{
    ...
    /// parser records on every <c>OutputItem</c>/<c>ExprNode</c> before the hidden-channel shift.
    /// A wrapper over the shared <see cref="LineIndex"/> (generator plan phase 6 D6) — the line rule itself lives

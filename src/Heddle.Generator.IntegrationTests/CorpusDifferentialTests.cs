...
namespace Heddle.Generator.IntegrationTests
{
    ...
    public class CorpusDifferentialTests
    {
        ...
        {
            // Phase 2 (post-2.0) fixtures: at-escape (pure text + @@ escapes → raw collapse) and brace-misread
            // (pure static text) precompile; layout (a plain definition library) precompiles like the other
            // libraries. at-escape-comment-adjacent falls back (definition call sites), pinned by its runtime golden.
            "at-escape.heddle",
            "brace-misread.heddle",
            "layout.heddle",
            ...
            // and a typed @(Name) document — all supported constructs, so each precompiles.
            "trycompile-parity-child.heddle",
            "trycompile-parity-parent.heddle",
            "trycompile-parity-typed.heddle",
        };

...
public interface IHeddleParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterDef_region_type([NotNull] HeddleParser.Def_region_typeContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="HeddleParser.def_region_type"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitDef_region_type([NotNull] HeddleParser.Def_region_typeContext context);
	/// <summary>

...
namespace Heddle.Tool.Tests
{
    ...
    /// as <c>src/Heddle.Tool.Tests/test-classes.txt</c>, compared as a set. It is what CI has instead of a
    ...
    public class TestClassInventoryTests
    {
        ...
        public void ThisSuiteDeclaresExactlyTheTestClassesCheckedIn()
        {
            TestClassInventory.AssertMatchesCheckedInInventory(
                typeof(TestClassInventoryTests).Assembly, "src/Heddle.Tool.Tests/test-classes.txt");
        }
    }
}

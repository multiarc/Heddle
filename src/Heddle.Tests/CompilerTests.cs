...
using AssemblyHelper = Heddle.Native.AssemblyHelper;
    ...
    namespace Tests
    {
        public static class TestClass
        {
            ...
            var compilation = CSharpCompilation.Create(
                ...
                AssemblyHelper.GetApplicationReferences().Where(m => !m.Display.Contains("Heddle")),
            ...
            //        $"{string.Join("\n", AssemblyHelper.GetApplicationReferences().Where(m => !m.Display.Contains("Heddle")).Select(r => r.Display))}");
            //}
        }
    }
}
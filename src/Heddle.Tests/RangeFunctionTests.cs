...
namespace Heddle.Tests
{
    ...
    public class RangeFunctionTests
    {
        ...
        public static ForModel HostRange(int start, int last, int step) =>
            new ForModel { Start = start, Last = last, Step = 1 };
        ...
        [Fact] // range() in the default registry — two- and three-arg overloads produce ForModel

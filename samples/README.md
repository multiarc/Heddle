...
| 7 | [`component-props-slots`](component-props-slots) | [Props](../docs/language-reference.md#props) | The card/layout/picker component library: typed props with defaults, parameterized slots |
...
| 10 | [`streaming-ssr`](streaming-ssr) | [Streaming](../docs/csharp-api.md#streaming-into-a-sink) | `Generate(data, IBufferWriter<byte>)` into `Response.BodyWriter` + `FlushAsync`; string-parity asserted in capture |

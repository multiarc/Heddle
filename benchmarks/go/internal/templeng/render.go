...
// RenderComposedPage renders workload 1 via templ (model.Composed() loads the nav fixture
// exactly once — sync.Once — so the per-render cost is a call plus a struct copy).

...
// Workload 2 — trivial-substitution, templ controlled port: byte-parity with the shared

// golden after normalization. The pinned one-line <article> card, ten substitutions in

// pinned order including the two attribute positions — identical authoring to the

// feasibility spike's P1 probe, which passed the full byte gate.

...
<head>
    ...
    <%include file="chrome-assets-styles.mako"/>
    <style>
        <%include file="chrome-custom-styles.mako"/>
    </style>
    <%include file="chrome-head-scripts.mako"/>
</head>
<body>
    <%include file="chrome-body-scripts.mako"/>
    <div>
    ...
    <div class="main">
        <header>
            ...
            <nav class="hide top-nav secondary-nav">
                <%include file="chrome-secondary-wholesale-menu.mako"/>
                <%include file="chrome-secondary-retail-menu.mako"/>
            </nav>
...
% endfor
    ...
    <%include file="chrome-assets-scripts.mako"/>
    <script src="/app/modules/profile/gccheckform.js"></script>
    <%include file="chrome-body-end-scripts.mako"/>
</body>
</html>

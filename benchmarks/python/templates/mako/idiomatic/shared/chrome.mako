...
<%def name="secondary_wholesale_menu()">\
				<ul class="hide">
                <li>
                <a href="#">New</a>
                </li>
...
<%def name="secondary_retail_menu()">\
				<ul class="hide">
                <li>
                <a href="#">New</a>
                </li>
...
<%def name="alert_below()">\

    \
</%def>\
<%def name="assets_styles()">\
<link rel="stylesheet" href="/main.css" />\
</%def>\
<%def name="assets_scripts()">\
<script src="/main.js"></script>\
</%def>\
<%def name="custom_styles()">\
/* CSS Comment Test */\
</%def>\
<%def name="head_scripts()">\
<script src="/head.js"></script>\
</%def>\
<%def name="body_scripts()">\
<script src="/body.js"></script>\
</%def>\
<%def name="body_end_scripts()">\

"""pyperf render bench -- Jinja2 x idiomatic track.
...
provably runs in the same process that produces every timed value. A verifier
...
# Hard gate: every cell, every worker, before any registration.
for w in WORKLOADS:

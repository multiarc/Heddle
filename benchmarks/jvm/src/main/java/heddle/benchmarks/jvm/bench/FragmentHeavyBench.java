...
/**
 * fragment-heavy (raw suite) - WI5 benchmark class. Annotations are the spec D9 pin: JMH
...
public class FragmentHeavyBench {

    private static final String WORKLOAD = "fragment-heavy";

    private Object model;

    @Setup(Level.Trial)
    public void setup() {
        model = Models.FRAGMENT_ROWS;
    ...
    private String renderJteControlled() {
        return JteEngines.renderPlain("controlled/fragment-heavy.jte", model);
    }

    private String renderJteIdiomatic() {
        return JteEngines.renderPlain("idiomatic/fragment-heavy.jte", model);
    }

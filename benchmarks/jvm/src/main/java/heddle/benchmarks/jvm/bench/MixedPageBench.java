...
/**
 * mixed-page (raw suite) - WI5 benchmark class. Annotations are the spec D9 pin: JMH
...
public class MixedPageBench {

    private static final String WORKLOAD = "mixed-page";
    ...
    private String renderJteControlled() {
        return JteEngines.renderPlain("controlled/mixed-page.jte", model);
    }

    private String renderJteIdiomatic() {
        return JteEngines.renderPlain("idiomatic/mixed-page.jte", model);
    }

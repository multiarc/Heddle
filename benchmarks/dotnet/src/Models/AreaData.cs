...
{
    /// <summary>The area fragments the composed-page layout renders, keyed by area name.</summary>
    public static class AreaData
    {
        ...
        static AreaData()
        {
            ...
            Store.Add("Wholesale Top Mega Menu", @"<div class=""top-menu-wrapper"">
                <ul class=""top-menu"">
            ...
            Store.Add("Retail Top Mega Menu", @"<div class=""top-menu-wrapper"">
                <ul class=""top-menu"">
                <li class=""shop-all-products"">
                <a href=""#"" class=""drop"">Shop All Products</a>
                <div class=""dropdown_2columns"">
            ...
            Store.Add("Footer Links", @"<div class=""footer-links-column"">
                <span>Need Help?</span>
                <ul>

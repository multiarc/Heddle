...
namespace Heddle.Benchmarks.Dotnet.Models
{
    ...
    public static class NavData
    {
            ...
            T("Shop All Products", "#", "shop-all-products",
                ...
                C(
                    S("OMEGA-3s AND SUPPLEMENTS", "/products/omega-3s-herbs-tests-vitamin-d-and-astaxanthin",
                        ...
                        L("Omega-3/6 Test Kit", "/products/omega-3-6-test"),
                    ...
                    S("COOKS TOOLS AND BOOKS", "",
                        L("Gift Certificates", "/product/gift-certificate?cat=278"),
                ...
                C(
                    ...
                    S("NEW PRODUCTS", "/products/new-products"),
        ...
        private static MenuTab AboutUs() =>
            T("About Us", "#", "about-us",
                C(
                    S("WHO WE ARE: OUR STORY", "",
                        L("About Us", "/content/about-us"),
                        L("Our Mission", "/content/our-mission"),
                        L("Customer and Expert Reviews", "/content/customer-reviews"))),
                C(
                    S("WHY WE ARE DIFFERENT", "",
                        L("Purity Standards", "/content/purity-story"),
                        L("Green Stewardship Eco Programs", "/content/green-stewardship-program"),
            ...
            T("Learn", "#", "learn",
                ...
                C(
                    S("HEALTH AND NUTRITION", "",
                        L("Take the Omega-3/6 Test", "/product/the-omega-3-6-test-trade"),
                        ...
                        L("Healthy Mom and Baby", "/content/healthy-mom-baby"))),
                C(
                    S("ABOUT OUR PRODUCTS", "",
                        L("How to Prepare Seafood", "/content/cooking-tips"),
                        L("Kosher and Organic Certification", "/content/about-us#Organic"),
                        L("The Flash-Frozen Advantage", "/content/about-us#Flash-Frozen"),
                        L("Seafood Purity and Safety", "/content/purity-story"),
                        L("Superior Salmon, Naturally", "/content/about-us#Superior%20Salmon"))));

        private static MenuTab Cook() =>
            T("Cook", "#", "cook",
                C(
                    S("COOKING VIDEOS", "/recipe/seafood-cooking-videos"),
        ...
        private static List<NavColumn> FooterColumns() => new List<NavColumn>
        {
            C(S("Need Help?", "",
                ...
                L("Customer Rewards", "/content/Customer-Rewards-Program"),
                L("Returns and Exchanges", "/content/our-guarantee"),
                L("Shipping Information", "/content/shipping-information"))),
            C(S("Our Company", "",
                L("About Us", "/content/About-Us"),
                L("Guarantee", "/content/our-guarantee"),
                L("Testimonials", "/content/customer-reviews"),
                L("Purity Standards", "/content/Purity-Story"),
                L("Sustainability Policy", "/content/Sustainability"),
                L("Green Stewardship", "/content/Green-Stewardship-Program"),

...
namespace Heddle.Editor.Intellisense
{
    ...
    internal sealed class VsTextViewCreationListener : IVsTextViewCreationListener
    {
        ...
        public void VsTextViewCreated(IVsTextView textViewAdapter)
        {
            ...
            HeddleCommandFilter filter = new HeddleCommandFilter(view, _completionBroker);
    ...
    internal sealed class HeddleCommandFilter : IOleCommandTarget
    {
        ICompletionSession _currentSession;

        public HeddleCommandFilter(IWpfTextView textView, ICompletionBroker broker)
        {

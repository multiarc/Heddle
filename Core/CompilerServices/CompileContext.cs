...
namespace Templates.Core.CompilerServices {
    public class CompileContext: IDisposable {
        ...
        internal IDictionary<string, Type> Extensions
        {
        ...
        internal void ImportNamespace (string namespaceName)
        {
            _data.Ns.Imports.Add(new CodeNamespaceImport(namespaceName));
        }

        internal void AddReference (string assemblyName)
        {
        ...
        internal CodeMemberMethod GetNewMethod ()
        {
